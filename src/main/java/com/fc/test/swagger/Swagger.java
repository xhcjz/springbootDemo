...
public class Swagger {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				//设置标题
				.title("springDemo API文档")
				//描述
				.description("springDemo项目是努力打造springboot框架的极致细腻的脚手架")
				 //作者信息
                //.contact(new Contact(v2Config.getName(), null, V2Config.getEmail_account()))
                //服务条款URL
				//.termsOfServiceUrl("https://gitee.com/bdj/springDemo/wikis/")
				//版本
